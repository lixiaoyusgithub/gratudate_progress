...
class P_IT_GaitDataset(Dataset):
    def __init__(self, root_dir, transform=None, data_type='GEIs', view_type='_back'):
        ...
        # 存储要使用的视图类型，默认为 '_front'
        self.view_type = view_type

        # 构建 GAIT-IT 目录读取路径，使用用户选择的数据类型
        # 路径格式为 root_dir/Parkinson/*/data_type/*
        path_class_it = os.path.join(root_dir, 'Parkinson', '*', self.data_type, '*')
...
if __name__=="__main__":
    ...
    json_path = os.path.join(json_dir, 'P_IT_Extract_paths.json')
