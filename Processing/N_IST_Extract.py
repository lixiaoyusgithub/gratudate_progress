...
class N_IST_Extract(Dataset):
    def __init__(self, root_dir, transform=None, sub_folder_type='silhouettes', view_type='_front'):
        ...
        path_class = os.path.join(root_dir, 'N_IST_GEIs', '*', self.sub_folder_type)
...
if __name__ == "__main__":
    ...
    dataset = N_IST_Extract(p_root_dir)
    print(len(dataset))
    ...
    json_path = os.path.join(json_dir, 'N_IST_Extract_paths_byour_front.json')
